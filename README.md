...
<div style="border: 3px solid #ffffff; background-color: #1e1e1e; padding: 18px; margin: 20px 0; border-radius: 8px;">
  ...
  <strong>Научный руководитель:</strong> Кораблёв Анатолий Юрьевич<br>
  <strong>Год:</strong> 2026
</div>
...
<div style="border: 3px solid #ffffff; background-color: #1e1e1e; padding: 22px; margin: 20px 0; border-radius: 8px;">
  ...
  <ul>
    ...
    <li>Геймплей: walking simulator + branching dialogue</li>
    <li>Длительность: 20–30 минут</li>
  </ul>
</div>

<div style="border: 3px solid #ffffff; background-color: #1e1e1e; padding: 22px; margin: 20px 0; border-radius: 8px;">
  <h2 style="margin-top: 0; color: #ffffff;">Технологический стек</h2>
  <ul>
    <li><strong>Движок:</strong> Unity 2022.3 LTS (Universal Render Pipeline)</li>
    <li><strong>Рендеринг:</strong> URP + Shader Graph (PS1-эффекты)</li>
    <li><strong>Камера:</strong> Cinemachine</li>
    <li><strong>Ввод:</strong> Input System</li>
    <li><strong>Пост-обработка:</strong> Volume Profile</li>
  </ul>
</div>
